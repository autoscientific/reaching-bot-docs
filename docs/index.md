...
User documentation for ReachingBot and the ReachingBot Device Manager.
...
- [ReachingBot API](api.md) — drive the bot from your own scripts via HTTP
- [Troubleshooting](troubleshooting.md) — common issues and fixes

For additional help and support, email [info@autoscientific.co.uk](mailto:info@autoscientific.co.uk).
